...
def run_experiment(run_name, out_dir='./results', seed=None,
    ...
    fit_res = trainer.fit(dl_train, dl_test, epochs, max_batches=batches, print_every=6)
    # ========================
...
def save_experiment(run_name, out_dir, config, fit_res):
    ...
    output_filename = os.path.join(out_dir, run_name) + '.json'
...
if __name__ == '__main__':
    ...
    print('*** Starting ' + subcmd_fn.__name__ + ' with config:\n' + str(parsed_args))
